...
namespace miniexcel
{
  ...
  LittleEndianWriter::LittleEndianWriter (CFile * f)
  {
    m_pFile = f;
  }
  ...
  void CMiniExcel::Write (CFile * dest)
  {
