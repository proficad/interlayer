...
IMPLEMENT_SERIAL(CGridCellCheckCombo, CGridCell, VERSIONABLE_SCHEMA | CURVERSION )
...
void CGridCellCheckCombo::Serialize(CArchive &ar)
{
	AFX_MANAGE_STATE(AfxGetAppModuleState());
	CGridCell::Serialize(ar);
	ar.SerializeClass(RUNTIME_CLASS(CGridCellCheckCombo));
	if( ar.IsLoading() )	
	{
...
CStringArray* CGridCellCheckCombo::GetOptions()
{
	return &m_Strings;
}
