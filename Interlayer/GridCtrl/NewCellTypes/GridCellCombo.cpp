...
IMPLEMENT_SERIAL(CGridCellCombo, CGridCell, VERSIONABLE_SCHEMA | CURVERSION )
...
void CGridCellCombo::Serialize(CArchive &ar)
{
	AFX_MANAGE_STATE(AfxGetAppModuleState());
	CGridCell::Serialize(ar);
	ar.SerializeClass(RUNTIME_CLASS(CGridCellCombo));
	if( ar.IsLoading() )	
	{
...
CStringArray* CGridCellCombo::GetOptions()
{
	return &m_Strings;
}
