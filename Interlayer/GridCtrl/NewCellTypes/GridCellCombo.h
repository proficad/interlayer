...
class _GRID_API CGridCellCombo : public CGridCell
{
    friend class CGridCtrl;
    //DECLARE_DYNCREATE(CGridCellCombo)
	DECLARE_SERIAL(CGridCellCombo)
...
class _GRID_API CComboEdit : public CEdit
{
// Construction
public:
	CComboEdit();
...
class _GRID_API CInPlaceList : public CComboBox
{
