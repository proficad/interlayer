...
class _GRID_API CGridCellCheckCombo : public CGridCell
{
    friend class CGridCtrl;
  //  DECLARE_DYNCREATE(CGridCellCheckCombo)
	DECLARE_SERIAL(CGridCellCheckCombo)
...
class _GRID_API CCheckComboEdit : public CEdit
{
// Construction
public:
	CCheckComboEdit();
...
class _GRID_API CInPlaceCheckList : public CCheckComboBox
{
