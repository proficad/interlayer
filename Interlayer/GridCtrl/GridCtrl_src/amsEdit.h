...
//
class _GRID_API CAMSEdit : public CInPlaceEdit
{
public:
	// Construction/destruction
	CAMSEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
public:
	...
	{
	public:
		SelectionSaver(CInPlaceEdit* pEdit);
		SelectionSaver(CInPlaceEdit* pEdit, int nStart, int nEnd);
		~SelectionSaver();
...
/*
	// The DateBehavior class is used to allow the entry of date values.
	class TimeBehavior : public Behavior
	{
	public:
		// Construction
	...
	public:
		...
		boolean IsShowing24HourFormat() const;
		void ShowSeconds(bool bShowSeconds = true);
		boolean IsShowingSeconds() const;
...
//
class _GRID_API CAMSAlphanumericEdit : public CAMSEdit, 
                             public CAMSEdit::AlphanumericBehavior
{
public:
	// Construction
	CAMSAlphanumericEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
...
//
class _GRID_API CAMSMaskedEdit : public CAMSEdit, 
                       public CAMSEdit::MaskedBehavior
{
public:
	// Construction
	CAMSMaskedEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
...
//
class _GRID_API CAMSNumericEdit : public CAMSEdit, 
                        public CAMSEdit::NumericBehavior
{
public:
	CAMSNumericEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
...
//
class _GRID_API CAMSIntegerEdit : public CAMSNumericEdit
{
public:
	// Construction
	CAMSIntegerEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
...
//
class _GRID_API CAMSCurrencyEdit : public CAMSNumericEdit
{
public:
	// Construction
	CAMSCurrencyEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar);
...
//
class _GRID_API CAMSDateEdit : public CAMSEdit, 
                     public CAMSEdit::DateBehavior
{
public:
	// Construction
	CAMSDateEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar);
...
//
class _GRID_API CAMSMultiMaskedEdit : public CAMSEdit, 
                            public CAMSEdit::AlphanumericBehavior,
                            public CAMSEdit::NumericBehavior,
                            public CAMSEdit::MaskedBehavior,
                            public CAMSEdit::DateBehavior
{
public:
	CAMSMultiMaskedEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar);
