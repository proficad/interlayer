...
class _GRID_API CGridCell : public CGridCellBase
{
    friend class CGridCtrl;
    //DECLARE_DYNCREATE(CGridCell)
	DECLARE_SERIAL(CGridCell)
...
class _GRID_API CGridDefaultCell : public CGridCell
{
    //DECLARE_DYNCREATE(CGridDefaultCell)
	DECLARE_SERIAL(CGridDefaultCell)
