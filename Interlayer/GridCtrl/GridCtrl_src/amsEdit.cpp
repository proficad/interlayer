...
CAMSEdit::CAMSEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
BEGIN_MESSAGE_MAP(CAMSEdit, CInPlaceEdit)
...
BOOL CAMSEdit::OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult) 
{
	...
	return CInPlaceEdit::OnChildNotify(message, wParam, lParam, pLResult);
}

// Insures that text set via SetWindowText is valid.
LONG CAMSEdit::OnSetText(UINT wParam, LONG lParam)
{
	LONG nResult = CInPlaceEdit::Default();
...
CAMSEdit::SelectionSaver::SelectionSaver(CInPlaceEdit* pEdit) :
	m_pEdit(pEdit)
{
	ASSERT(pEdit);
...
CAMSEdit::SelectionSaver::SelectionSaver(CInPlaceEdit* pEdit, int nStart, int nEnd) :
	m_pEdit(pEdit),
	m_nStart(nStart),
	m_nEnd(nEnd)
{
...
// Constructs the object using the given set of strInvalidChars
CAMSAlphanumericEdit::CAMSAlphanumericEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
						   int nMaxChars /*= 0*/, const CString& strInvalidChars /*= _T("%'*\"+?><:\\"")*/):
AlphanumericBehavior(this, nMaxChars, strInvalidChars)
,CAMSEdit(pParent, rect, dwStyle, nID, nRow, nColumn, sInitText, nFirstChar)
{
}
...
CAMSMaskedEdit::CAMSMaskedEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,const CString& strMask /*= _T("")*/) :
...
// Constructs the object using the given nMaxWholeDigits and nMaxDecimalPlaces.
CAMSNumericEdit::CAMSNumericEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
						   int nMaxWholeDigits /*= 9*/, int nMaxDecimalPlaces /*= 4*/) :
...
CAMSIntegerEdit::CAMSIntegerEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar,
						   int nMaxWholeDigits /*= 9*/) :
	CAMSNumericEdit(pParent, rect, dwStyle, nID, nRow, nColumn, sInitText, nFirstChar,
		nMaxWholeDigits, 0)
{
}
...
// Constructs the object using the given numeric strMask.
CAMSCurrencyEdit::CAMSCurrencyEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar):
CAMSNumericEdit(pParent, rect, dwStyle, nID, nRow, nColumn, sInitText, nFirstChar)
{
...
CAMSDateEdit::CAMSDateEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar) :
	DateBehavior(this),
	CAMSEdit(pParent, rect, dwStyle, nID, nRow, nColumn, sInitText, nFirstChar)
...
CAMSMultiMaskedEdit::CAMSMultiMaskedEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
                           UINT nFirstChar) :
