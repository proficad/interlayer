...
//@**#---2002-12-23 16:05:40 (张军(ZhangJun))---#**@
//	
//  m_nType 类型
//
//	-1   缺省
...
// zj 2004.6.20 add
// 单位格 画线
#define CBL_NONE    0x00
#define CBL_LEFT    0x08
#define CBL_RIGHT   0x10
#define CBL_TOP     0x20
#define CBL_BOTTOM  0x40
#define CBL_RECT    (CBL_LEFT|CBL_RIGHT|CBL_TOP|CBL_BOTTOM)
//*********************//
...
typedef struct _GRID_API _GV_ITEM {
...
class _GRID_API CGridCellBase : public CObject
{
    friend class CGridCtrl;	
    DECLARE_DYNAMIC(CGridCellBase)

	//DECLARE_SERIAL(CGridCellBase)
...
public:
	// zj 2004.6.20 add
	virtual void SetCellBorderLine(int nBorderLine = CBL_RECT)		{ m_nBorderLine = nBorderLine;};
	virtual int  GetCellBorderLine()								{ return m_nBorderLine; };
	// ******************* //
...
private:
	...
	// zj 2004.6.20 add
	unsigned short m_nBorderLine; //单位格边框线
