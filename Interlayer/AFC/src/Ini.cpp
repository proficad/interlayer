...
CString CIni::GetValueString(LPCTSTR lpSection, LPCTSTR lpKey)
{
	DWORD dValue;
...
UINT CIni::GetValueInt(LPCTSTR lpSection, LPCTSTR lpKey)
{
	UINT iValue;	
	iValue=GetPrivateProfileInt(lpSection,lpKey,-1,m_strFileName);
	return iValue;
}
