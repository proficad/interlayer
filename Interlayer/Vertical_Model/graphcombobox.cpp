...
{
	dwStyle |= CBS_OWNERDRAWFIXED | CBS_DROPDOWNLIST | WS_VSCROLL | CBS_HASSTRINGS;
...
{
	// text colors
	COLORREF cvBack = ::SetBkColor(lpDrawItemStruct->hDC, ::GetSysColor((lpDrawItemStruct->itemState& ODS_SELECTED) ? COLOR_HIGHLIGHT : COLOR_WINDOW)); 
	COLORREF cvText = ::SetTextColor(lpDrawItemStruct->hDC, ::GetSysColor((lpDrawItemStruct->itemState& ODS_SELECTED) ? COLOR_HIGHLIGHTTEXT : COLOR_WINDOWTEXT)); 
	// focus rectangle
