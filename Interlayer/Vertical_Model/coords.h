...
public:
	...
	double ConvertToWorld(double value)
	{
		return XtoW(value);
	};
	double ConvertToScreen(double value)
	{
		return WtoX(value);
	};
	...
	BOOL IsPointInRangeW(double value)
	{
		return IsPointInRange(value, p_v1, p_v2);
	};
	BOOL IsPointInRangeX(double value)
	{
		return IsPointInRange(value, p_x1, p_x2);
	};
	...
	double WInterval()
	{
		return (double)fabs(p_v1 - p_v2);
	};
	double XInterval()
	{
		return (double)fabs(p_x1 - p_x2);
	};
