...
double CCoordinates::CountGrid(int NMax, double mx1, double mx2)
{
	...
	while (Delta > GridItem)
	{
		...
		case 1 :
			{
				Grid = 0.2f; GridItem = Grid * Mult;
			}; break; //Grid = 0.1
		case 2 :
			{
				Grid = 0.5f; GridItem = Grid * Mult;
			};	break;
		case 5 :
			{
				Grid = 1; GridItem = Grid * Mult;
			};	break;
		case 10 :
			{
				Grid = 2; GridItem = Grid * Mult;
			}; break;
		case 20 :
			{
				Grid = 5; GridItem = Grid * Mult;
			};	break;
		case 50 :
			{
				Grid = 0.1f;Mult = Mult * 10; GridItem = Grid * Mult;
			};	break; //Grid = 5
		};
	};
	return GridItem;
