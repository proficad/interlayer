...
{
	if (selnum < 0 || selnum >= grprops.GetSize())
		return;
...
void CGraphicsPropertyPage::SetHideShowAttr(int selnum)
{
	...
	if (grprop->IsVisible())
	{
		wnd->SetWindowText(_T("“˛≤ÿ"));
	}
	else
	{
		wnd->SetWindowText(_T("œ‘ æ"));
	};
}
/////////////////////////////////////////////////////////////////////////////
...
CGraphTitlePrompt::CGraphTitlePrompt(CWnd* pParent /*=NULL*/) : CDialog(CGraphTitlePrompt::IDD, pParent)
{
